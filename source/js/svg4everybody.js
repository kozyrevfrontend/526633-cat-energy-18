!function (root, factory) {
    ...
    function svg4everybody(rawopts) {
        function oninterval() {
                    ...
                    if (polyfill) {
                        if (!opts.validate || opts.validate(src, svg, use)) {
                            ...
                            if (url.length) {
                                ...
                                xhr
                                    ._embeds
                                    .push({parent: parent, svg: svg, id: id}), // prepare the xhr ready state change event
            ...
            (!uses.length || uses.length - numberOfSvgUseElementsToBypass > 0) && requestAnimationFrame(
                oninterval,
                67
            );
        }
        ...
        polyfill = "polyfill" in opts
            ...
            : newerIEUA.test(navigator.userAgent) || (
                navigator.userAgent.match(olderEdgeUA) || []
            )[1] < 10547 || (navigator.userAgent.match(webkitUA) || [])[1] < 537 || edgeUA.test(
                navigator.userAgent
            ) && inIframe;
